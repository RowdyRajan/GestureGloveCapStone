...
//
// These arrays are used to variably handle different requests.
// After receiving a request, a type and a req (request value) are taken from
// the ControlData structure. An If/else block selects the correct pointer array
// and the req is used as the index to select the element.
//*************************************************************************
